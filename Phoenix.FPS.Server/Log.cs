...
namespace Phoenix.FPS.Server
{
    public static class Log
    {
        ...
        public static void Info(string message, bool console = false) => Write("INFO", message, console);
        public static void Warn(string message, bool console = false) => Write("WARN", message, console);
        public static void Error(string message, bool console = false) => Write("ERROR", message, console);
        public static void Debug(string message, bool console = false) => Write("DEBUG", message, console);
        public static void Exception(string message, bool console = false) => Write("EXCEPTION", message, console);
                
        private static void Write(string level, string message, bool console)
        {
            if (!Enabled)
                return;
